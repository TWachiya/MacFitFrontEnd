                ...
                <v-form @submit.prevent >
                    <v-card>
                        ...
                        <v-card-text>
                            <v-row>
                                <v-col md="12">
                                    <v-text-field label="Role Name" v-model="rolename" required :rules="[rules.required]"></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col md="12">
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-row>
                             ...
                             <v-row>
                                <v-col md="6">
                                    <v-text-field label="Model_no" v-model="model_no" required :rules="[rules.required]"></v-text-field>
                                </v-col>
                                <v-col md="6">
